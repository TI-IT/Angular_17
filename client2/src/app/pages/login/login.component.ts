...
@Component({
  selector: 'app-login',
  standalone: true,
  imports: [ReactiveFormsModule, CommonModule, FormsModule, HttpClientModule, MatIcon, GoogleSigninButtonModule, MatLabel, MatFormField, MatError, MatInput, MatButton],
...
export class LoginComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    // Google Oauth
    this._authGoogleService.authState.subscribe((userGoogle) => {
